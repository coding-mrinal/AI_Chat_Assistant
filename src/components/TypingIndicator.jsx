...
const TypingIndicator = () => {
  return (
    <div className="flex justify-start px-1">
      <div className="flex items-center gap-2 sm:gap-3 max-w-3xl">
        ...
        <div className="bg-gray-100 dark:bg-gray-700 px-3 sm:px-4 py-2 sm:py-3 rounded-xl sm:rounded-2xl">
