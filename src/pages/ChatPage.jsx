...
const ChatPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-300 h-screen overflow-hidden">
      <div className="flex-1 overflow-y-auto chat-scrollbar pb-2">
